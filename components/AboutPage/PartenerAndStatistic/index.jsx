    ...
    <section>
      <div className="max-w-6xl mx-auto py-28">
        ...
        <div className="relative max-w-screen-lg mx-auto mt-32">
          ...
          />
          <div className="grid grid-cols-3 justify-center items-center divide-x-2 divide-content-green-primary/60 py-10 px-20 gap-5 rounded-md shadow-2xl shadow-btn-shadow">
