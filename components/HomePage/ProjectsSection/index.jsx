    ...
    <section className="py-32 bg-primary-bg">
      <div className="grid grid-cols-2 items-center max-w-7xl mx-auto">
        <div className="flex flex-col gap-7 w-[33.7rem] ml-auto">
          ...
          <Button
            title="Explore"
            className="bg-primary-green rounded-xsm text-white h-11 w-56 font-bold shadow-2xl shadow-btn-shadow"
          />
        </div>
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-5 ">
          <img
            ...
            alt="project home 1"
            className="w-60 h-52 ml-auto mt-auto object-cover shadow-2xl shadow-btn-shadow"
          />
          <img
          ...
          <img
            ...
            alt="project home 1"
            className="w-[12.125rem] h-64 object-cover ml-auto shadow-2xl shadow-btn-shadow"
          />
          <img
